...
@section('content')
    ...
    <h5>Adding New Lesson</h5>

    <form method="POST" action="{{ route('dashboard.admin.course.lesson.store') }}" enctype="multipart/form-data" id="myForm">
        @csrf
        <div class="mb-3">
            <label for="title" class="form-label">Title:</label>
            <input type="hidden" name="course_id" class="form-control" id="course_id" value="{{ $course->id }}">
